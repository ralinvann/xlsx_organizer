...
export function LoginScreen({ onLogin, onBack, onGuest }: LoginScreenProps) {
  ...
  const handleGuestAccess = () => onGuest?.();
      ...
      <div className="w-full max-w-md mx-auto">
        <Card className="shadow-xl border-2 border-primary/20">
          <CardHeader className="text-center space-y-4 relative">
            {onBack && (
              <Button variant="ghost" size="sm" onClick={onBack} className="absolute left-2 top-2 h-8 w-8 p-0">
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <Button onClick={handleSubmit} className="w-full h-14 text-xl" size="lg" disabled={loading}>
            ...
            <div className="pt-4 border-t border-border">
              <div className="text-center">
                ...
                <Button variant="outline" size="lg" className="w-full h-12 text-lg" onClick={handleGuestAccess}>
